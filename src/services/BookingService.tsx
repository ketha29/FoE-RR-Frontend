...
const GET_WEEK_BOOKING = (weekStartDate: string, weekEndDate: string) => `${BASE_URL}/week/${weekStartDate}/${weekEndDate}`
...
export const getWeekBookings = async (weekStartDate: string, weekEndDate: string) => {
